    ...
    describe "for signed-in users" do
      ...
      describe "micropost sidebar" do
        ...
        describe "micropost counts" do
          ...
          describe "when there are many feeds" do
            it { should have_content("#{user.microposts.count} microposts") }
          end

          describe "when there is only one feed" do
            before do 
              (user.microposts.count - 1 ).times { click_link("delete") }
            end
          ...
          describe "when there are no feeds" do
            before do 
              user.microposts.count.times { click_link("delete") }
            end
